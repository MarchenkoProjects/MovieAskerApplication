...
public final class Constants {
    ...
    public static final class URI {
        ...
        public static final String POST_USER_FAVORITE = USERS + "/{id_user}/films/{id_film}/favorite";
        public static final String POST_USER_LOOKED = POST_USER_FAVORITE + "?looked={looked}";
    }
